---
description: Translate article files between English and Japanese
handoffs: 
  - label: Translate File Content
    agent: kktsuji.translate
    prompt: Translate the given file content
    send: true
---
